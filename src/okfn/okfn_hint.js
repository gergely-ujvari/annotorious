goog.provide('annotorious.okfn.Hint');
 ...
 * @constructor
 */
annotorious.okfn.Hint = function(annotator, wrapperElement, opt_msg) {
  var self = this;
  ...
  goog.style.setStyle(this.element, 'left', offset.left + 'px');
  goog.style.setStyle(this.element, 'top', offset.top + 'px');

  this._attachListeners();
  this.hide();
  goog.dom.appendChild(wrapperElement, this.element);
}
